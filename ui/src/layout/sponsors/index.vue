<template>
	<div class="sponsors-container" title="点击前往" v-show="state.sponsors.isShow" @click="onSponsorsClick">
		...
		<div class="sponsors-close">
			<SvgIcon name="ele-Close" :size="12" title="关闭" @click.stop="onCloseSponsors" />
		</div>
	</div>
</template>
...
import sponsorsOne from '/@/assets/login-icon-two.svg';
		...
		list: [
			{
				url: sponsorsOne,
				text: `Owl Messager`,
				link: 'https://github.com/lishimeng/owl-messager',
			},
		],
		isShow: false,
		index: 0,
