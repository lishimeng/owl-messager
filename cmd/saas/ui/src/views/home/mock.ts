...
import {HomeOne, HomeThree} from "/src/views/home/home";

export const getHomeOne = (): HomeOne[] => {
    return [
        {
            num1: '125,12',
            num2: '-12.32',
            num3: '短信统计信息',
            num4: 'fa fa-comments-o',
            color1: '#FF6462',
...
export const getHomeThree = (): HomeThree[] => {
    return [
        {
