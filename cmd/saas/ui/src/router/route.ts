...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		...
		children: [
						...
						children: [
							{
								...
								component: () => import('/src/views/limits/frontEnd/page/index.vue'),
								meta: {
							...
							},
							{
								...
								component: () => import('/src/views/limits/frontEnd/btn/index.vue'),
								meta: {
						...
						children: [
							{
								...
								component: () => import('/src/views/limits/backEnd/page/index.vue'),
								meta: {
			...
			},
			{
				...
				children: [
						...
						children: [
							{
								...
								name: 'menu11',
								component: () => import('/src/views/menu/menu1/menu11/index.vue'),
								meta: {
								...
								children: [
									{
										...
										name: 'menu121',
										component: () => import('/src/views/menu/menu1/menu12/menu121/index.vue'),
										meta: {
									...
									},
									{
										...
										name: 'menu122',
										component: () => import('/src/views/menu/menu1/menu12/menu122/index.vue'),
										meta: {
							...
							},
							{
								...
								name: 'menu13',
								component: () => import('/src/views/menu/menu1/menu13/index.vue'),
								meta: {
					...
					},
					{
						path: '/menu/menu2',
						name: 'menu2',
						component: () => import('/src/views/menu/menu2/index.vue'),
						meta: {
				...
				children: [
					{
						path: '/fun/tagsView',
						name: 'funTagsView',
						component: () => import('/src/views/fun/tagsView/index.vue'),
						meta: {
					...
					},
					{
						path: '/fun/countup',
						name: 'funCountup',
						component: () => import('/src/views/fun/countup/index.vue'),
						meta: {
					...
					},
					{
						path: '/fun/wangEditor',
						name: 'funWangEditor',
						component: () => import('/src/views/fun/wangEditor/index.vue'),
						meta: {
					...
					},
					{
						path: '/fun/cropper',
						name: 'funCropper',
						component: () => import('/src/views/fun/cropper/index.vue'),
						meta: {
					...
					},
					{
						path: '/fun/qrcode',
						name: 'funQrcode',
						component: () => import('/src/views/fun/qrcode/index.vue'),
						meta: {
					...
					},
					{
						path: '/fun/echartsMap',
						name: 'funEchartsMap',
						component: () => import('/src/views/fun/echartsMap/index.vue'),
						meta: {
					...
					},
					{
						path: '/fun/printJs',
						name: 'funPrintJs',
						component: () => import('/src/views/fun/printJs/index.vue'),
						meta: {
					...
					},
					{
						path: '/fun/clipboard',
						name: 'funClipboard',
						component: () => import('/src/views/fun/clipboard/index.vue'),
						meta: {
					...
					},
					{
						path: '/fun/gridLayout',
						name: 'funGridLayout',
						component: () => import('/src/views/fun/gridLayout/index.vue'),
						meta: {
					...
					},
					{
						path: '/fun/splitpanes',
						name: 'funSplitpanes',
						component: () => import('/src/views/fun/splitpanes/index.vue'),
						meta: {
				...
				children: [
					{
						...
						name: 'pagesFiltering',
						component: () => import('/src/views/pages/filtering/index.vue'),
						meta: {
						...
						children: [
							{
								...
								component: () => import('/src/views/pages/filtering/details.vue'),
								meta: {
					...
					},
					{
						...
						component: () => import('/src/views/pages/filtering/details1.vue'),
						meta: {
					...
					},
					{
						path: '/pages/iocnfont',
						name: 'pagesIocnfont',
						component: () => import('/src/views/pages/iocnfont/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/element',
						name: 'pagesElement',
						component: () => import('/src/views/pages/element/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/awesome',
						name: 'pagesAwesome',
						component: () => import('/src/views/pages/awesome/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesFormAdapt',
						component: () => import('/src/views/pages/formAdapt/index.vue'),
						meta: {
					...
					},
					{
						...
						component: () => import('/src/views/pages/tableRules/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/formI18n',
						name: 'pagesFormI18n',
						component: () => import('/src/views/pages/formI18n/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesFormRules',
						component: () => import('/src/views/pages/formRules/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesListAdapt',
						component: () => import('/src/views/pages/listAdapt/index.vue'),
						meta: {
					...
					},
					{
						...
						name: 'pagesWaterfall',
						component: () => import('/src/views/pages/waterfall/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/steps',
						name: 'pagesSteps',
						component: () => import('/src/views/pages/steps/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/preview',
						name: 'pagesPreview',
						component: () => import('/src/views/pages/preview/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/waves',
						name: 'pagesWaves',
						component: () => import('/src/views/pages/waves/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/tree',
						name: 'pagesTree',
						component: () => import('/src/views/pages/tree/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/drag',
						name: 'pagesDrag',
						component: () => import('/src/views/pages/drag/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/lazyImg',
						name: 'pagesLazyImg',
						component: () => import('/src/views/pages/lazyImg/index.vue'),
						meta: {
					...
					},
					{
						...
						component: () => import('/src/views/pages/dynamicForm/index.vue'),
						meta: {
					...
					},
					{
						path: '/pages/workflow',
						name: 'pagesWorkflow',
						component: () => import('/src/views/pages/workflow/index.vue'),
						meta: {
				...
				children: [
					{
						path: '/make/selector',
						name: 'makeSelector',
						component: () => import('/src/views/make/selector/index.vue'),
						meta: {
					...
					},
					{
						path: '/make/noticeBar',
						name: 'makeNoticeBar',
						component: () => import('/src/views/make/noticeBar/index.vue'),
						meta: {
					...
					},
					{
						path: '/make/svgDemo',
						name: 'makeSvgDemo',
						component: () => import('/src/views/make/svgDemo/index.vue'),
						meta: {
					...
					},
					{
						path: '/make/tableDemo',
						name: 'makeTableDemo',
						component: () => import('/src/views/make/tableDemo/index.vue'),
						meta: {
				...
				children: [
					{
						path: '/params/common',
						name: 'paramsCommon',
						component: () => import('/src/views/params/common/index.vue'),
						meta: {
					...
					},
					{
						...
						component: () => import('/src/views/params/common/details.vue'),
						meta: {
					...
					},
					{
						path: '/params/dynamic',
						name: 'paramsDynamic',
						component: () => import('/src/views/params/dynamic/index.vue'),
						meta: {
					 ...
					 */
					{
						...
						component: () => import('/src/views/params/dynamic/details.vue'),
						meta: {
				...
				children: [
					{
						...
						component: () => import('/src/layout/routerView/link.vue'),
						meta: {
			...
			},
			{
				path: '/chart',
				name: 'chartIndex',
				component: () => import('/src/views/chart/index.vue'),
				meta: {
			...
			},
			{
				path: '/personal',
				name: 'personal',
				component: () => import('/src/views/personal/index.vue'),
				meta: {
