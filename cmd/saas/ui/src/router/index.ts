...
import { staticRoutes, notFoundAndNoPower } from '/src/router/route';
import { initFrontEndControlRoutes } from '/src/router/frontEnd';
import { initBackEndControlRoutes } from '/src/router/backEnd';
