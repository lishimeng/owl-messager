<template>
  <div>
    ...
    <!--    microsoft      -->
    <div v-show="props.vendor=='microsoft'">
    ...
    <!--        阿里云sms ali_yun-->
    <div v-show="props.vendor=='ali_yun'">
      <el-form style="margin-top: 20px"
               :model="state.aliYun"
               ref="aliYunFormRef"
               label-width="120px">
    ...
    <!--        华为云sms huawei_yun-->
    <div v-show="props.vendor=='huawei_yun'">
      <el-form style="margin-top: 20px"
...
onMounted(() => {
  if (props.config) {
    loadJson(props.vendor, props.config);
  }
})
