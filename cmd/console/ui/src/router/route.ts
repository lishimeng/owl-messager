...
export const dynamicRoutes: Array<RouteRecordRaw> = [
    {
        ...
        children: [
            ...
            },
            {
                path: '/template',
                name: 'Template',
                component: () => import('/src/views/template/index.vue'),
                meta: {
            ...
            },
            {
                path: '/sender',
                name: 'sender',
                component: () => import('/src/views/sender/sms/index.vue'),
                meta: {
            ...
            //     path: '/system',
            //     name: 'system',
            //     component: () => import('/src/layout/routerView/parent.vue'),
...
export const staticRoutes: Array<RouteRecordRaw> = [
     ...
     */
    {
        ...
        component: () => import('/src/views/visualizing/demo1.vue'),
        meta: {
    ...
    },
    {
        ...
        component: () => import('/src/views/visualizing/demo2.vue'),
        meta: {
