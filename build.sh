...
build_special(){
  ...
  case $1 in
      owl-messager)
      log_debug "owl-messager -> [cmd/owl-messager]"
      AppPath='cmd/owl-messager'
      ;;
      owl-console)
      log_debug "owl-console -> [cmd/console]"
      AppPath='cmd/console'
      ;;
      *)
      exit 0
...
build_all(){
  ...
  if [ $# -eq 1 ]; then
    ...
    build_special "$1"
  	...
  	build_application 'owl-messager' 'cmd/owl-messager'
  	build_application 'owl-console' 'cmd/console'
  fi
}
